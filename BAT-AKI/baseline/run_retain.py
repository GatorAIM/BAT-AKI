...
from function.retain_func import (
...
def parse_args():
    ...
    parser.add_argument("--label_col", default=".", help="")
    parser.add_argument("--use_tokenizer", action=".", help="")
    ...
    parser.add_argument("--unit_list", default="2000", help="")
    ...
    parser.add_argument("--ckpt_name_fmt", default="retain_best_seed{seed}.pt", help="")
